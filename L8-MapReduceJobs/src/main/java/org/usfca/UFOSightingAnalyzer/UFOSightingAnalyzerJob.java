...
public class UFOSightingAnalyzerJob  {
    public static void main(String[] args){
        try{
            Configuration configuration = new Configuration();
            Job analyzerJob = Job.getInstance(configuration, "UFO Sighting Analyzer Job");

            /* Current class */
            analyzerJob.setJarByClass(UFOSightingAnalyzerJob.class);

            /* Mapper class */
            analyzerJob.setMapperClass(UFOSightingMapper.class);

            /* Reducer class*/
            analyzerJob.setReducerClass(UFOSightingReducer.class);
